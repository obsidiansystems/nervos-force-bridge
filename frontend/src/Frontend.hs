...
nervosSvg :: forall t m. (PostBuild t m, DomBuilder t m) => m (Element EventResult (DomBuilderSpace m) t, ())
nervosSvg =
  elDynAttrNS' (Just "http://www.w3.org/2000/svg") "svg" (pure $ Map.fromList [("xmlns", "http://www.w3.org/2000/svg"), ("viewBox","0 0 60 61"), ("width","1em"), ("height","1em"), ("fill","currentColor"), ("aria-hidden","true"), ("focusable","false")]) $ do
...
cardanoSvg :: forall t m. (PostBuild t m, DomBuilder t m) => m (Element EventResult (DomBuilderSpace m) t, ())
cardanoSvg =
  elDynAttrNS' (Just "http://www.w3.org/2000/svg") "svg" (pure $ Map.fromList [("version","1.1"),("width", "30px"), ("height", "30px"), ("x","0px"), ("y","0px"),
...
filledCircleArrowSvg = elDynAttrNS (Just "xmlns=http://www.w3.org/2000/svg") "svg" (pure $ Map.fromList [("viewBox","0 0 22 22"), ("fill","currentColor"), ("width","1em"), ("height","1em"), ("aria-hidden","true"), ("focusable","false")]) $ do
...
arrowSvg = elDynAttrNS Nothing "svg" (pure $ Map.fromList [("viewBox","64 64 896 896"), ("focusable","false"), ("data-icon","arrow-right"), ("width","1em"), ("height","1em"), ("fill","currentColor"), ("aria-hidden","true")]) $ do
  elAttr "path" ("d" =: "M869 487.8L491.2 159.9c-2.9-2.5-6.6-3.9-10.5-3.9h-88.5c-7.4 0-10.8 9.2-5.2 14l350.2 304H152c-4.4 0-8 3.6-8 8v60c0 4.4 3.6 8 8 8h585.1L386.9 854c-5.6 4.9-2.2 14 5.2 14h91.5c1.9 0 3.8-.7 5.2-2L869 536.2a32.07 32.07 0 000-48.4z") blank
...
chainSvg "Nervos" = do -- nervosSvg >> pure ()
  --elAttr "image" ("href" =: $(static "svgs/nervos.svg")) blank
  let dSvgEl = pure $ S.SVG_El (S.Width 30) (S.Height 30) Nothing

      dPath1 = pure $ _Wrapped # NE.fromList
  ...
  _ <- S.svg_ dSvgEl $ do
    S.svgBasicDyn_ S.Path S.makePathProps dPath1
    --elAttr "path" (Map.fromList [("d","M0 0.0227051V60.0227H15.3559V27.3292H27.1276L0 0.0227051Z"),("fill","black")]) blank
    --elAttr "path" (Map.fromList [("d","M44.6441 0.0227051V32.7165H32.8727L60 60.0227V0.0227051H44.6441Z"),("fill","black")]) blank
...
chainSvg "Cardano" = do
  ...
  let
    ...
    attrs = Map.fromList [("id", "svg1"), ("class", "blue no-yellow")]
